...
2. При бэктесте использовать готовый конфигурационный файл `/freqtrade/user_data/config/config_crypto_futures.json`. В нем уже прописаны `"trading_mode": "futures"`, isolation margin и суффиксы пар `:USDT`. Самим создавать его или копировать больше не нужно!
