...
3. Данные скачаны за достаточный период (**минимум 60-90 дней** для 1h таймфрейма)
...
- **Данные:** чем больше, тем надёжнее результат. На 2 неделях данных hyperopt
  практически бесполезен — слишком мало сделок для статистики. Скачай минимум 90 дней
  (см. skill `data`).
