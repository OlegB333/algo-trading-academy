...
Если фоновый бот запущен — FreqUI уже онлайн, достаточно обновить страницу.
Если бот был остановлен — запусти: `docker compose up -d`.

В FreqUI перейди в раздел **Backtest** в левом меню.
